...
export default function Navbar() {
  ...
  return (
    <nav className="fixed top-0 left-0 w-full h-16 z-50 backdrop-blur-2xl bg-white/70 dark:bg-neutral-900/60 border-b border-neutral-200/60 dark:border-neutral-800">
      ...
      <motion.a href="#" variants={container} initial='initial' animate='animate' className="flex flex-1 text-lg md:text-xl">
        {name.map(n => <motion.li variants={item} className="text-neutral-900 dark:text-white">
              {n}
          </motion.li>)}
      </motion.a>
        <li>
